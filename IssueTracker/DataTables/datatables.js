 ...
 *   https://datatables.net/download/#bs/dt-1.11.2/r-2.2.9/sb-1.2.1/sp-1.4.0
 *
 * Included libraries:
 *   DataTables 1.11.2, Responsive 2.2.9, SearchBuilder 1.2.1, SearchPanes 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.11.2/r-2.2.9/sb-1.2.1/sp-1.4.0",
